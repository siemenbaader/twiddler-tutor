...
smalltalk.addClass('Tutor', smalltalk.Widget, ['twiddlerKeypad', 'lesson'], 'Tutor');
smalltalk.addMethod(
smalltalk.method({
selector: "initialize",
category: 'not yet classified',
...
return smalltalk.withContext(function($ctx1) { 
var $1,$3,$4,$5,$6,$7,$8,$9,$10,$2,$11,$12;
_st(html)._style_(" .menu-bar {\x0a\x09\x09}");
$1=_st(html)._div();
_st($1)._class_("menu-bar");
$2=_st($1)._with_((function(){
return smalltalk.withContext(function($ctx2) {
$3=_st(html)._button();
_st($3)._with_("Recreate App");
...
return smalltalk.withContext(function($ctx3) {
$7=_st(html)._option();
_st($7)._with_("lesson 1");
$8=_st($7)._value_("1");
$8;
$9=_st(html)._option();
_st($9)._with_("lesson 2");
$10=_st($9)._value_("2");
return $10;
...
args: ["html"],
source: "renderOn: html\x0a\x09\x22render the whole application\x22\x0a\x0a\x09html style: \x0a\x09\x09' .menu-bar {\x0a\x09\x09}'.\x0a\x09\x0a\x09html div\x0a\x09\x09class: 'menu-bar';\x0a\x09\x09with: [ \x0a\x09\x09\x09html button \x0a\x09\x09\x09\x09with: 'Recreate App';\x0a\x09\x09\x09\x09onClick: [Tutor begin].\x0a\x09\x09\x09\x0a\x09\x09\x09html button\x0a\x09\x09\x09\x09with: 'More button';\x0a\x09\x09\x09\x09onClick: [Transcript show: 'more clicked'].\x0a\x09\x09\x09\x09\x0a\x09\x09\x09html select\x0a\x09\x09\x09\x09with: [\x0a\x09\x09\x09\x09\x09html option with: 'lesson 1'; value: '1'.\x0a\x09\x09\x09\x09\x09html option with: 'lesson 2'; value: '2'.\x0a\x09\x09\x09\x09].\x0a\x09\x09\x09].\x0a\x09\x09\x09\x0a\x09\x09\x09html hr.\x0a\x09\x09\x09\x0a\x09\x09\x09html div\x0a\x09\x09\x09\x09with: [\x0a\x09\x09\x09\x09\x09html with: twiddlerKeypad.\x0a\x09\x09\x09\x09\x09html with: lesson.\x0a\x09\x09\x09\x09].\x0a\x09\x09\x09html div style: 'clear: both'; class: 'clearfix'.\x0a\x0a\x09\x09",
messageSends: ["style:", "class:", "div", "with:", "button", "onClick:", "begin", "show:", "select", "option", "value:", "hr"],
referencedClasses: ["Tutor", "Transcript"]
}),
smalltalk.Tutor);
